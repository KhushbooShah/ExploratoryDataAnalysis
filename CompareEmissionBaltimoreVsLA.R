...
baltimoreAndlosangeles <- nei[nei$fips == "24510" | nei$fips ==  "06037", ]

#subsets based on motor vehicles, type = ON-ROAD
bla_vehicles <- baltimoreAndlosangeles[baltimoreAndlosangeles$type == "ON-ROAD", ]
...
png("Emissions-Baltimore-Vs-LosAngeles.png")
